...
function About() {
    ...
    const statColors = useMemo(() => [
        ['from-rose-100 to-pink-100', 'text-rose-500'],
    ...
    return (
        <Suspense fallback={<LoadingFallback />}>
            <main id="main-content" className="bg-white">
                ...
                <section
                    className="relative py-20 lg:py-28 px-5 lg:px-30 overflow-hidden bg-white"
                    aria-labelledby="hero-title"
                    role="region"
                >
                    {/* Background decorative shapes - simplified for performance */}
                    <div
                        className="absolute top-0 left-0 w-72 h-72 bg-blue-100/40 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2"
                        aria-hidden="true"
                        role="presentation"
                    />
                    <div
                        className="absolute bottom-0 right-0 w-96 h-96 bg-teal-100/30 rounded-full blur-3xl translate-x-1/2 translate-y-1/2"
                        aria-hidden="true"
                        role="presentation"
                    />
                ...
                <section
                    className="py-20 px-5 lg:px-30 bg-gray-50/50"
                ...
                {/* Core Values Section */}
                <section
                    className="py-20 px-5 lg:px-30 bg-white"
                    aria-labelledby="core-values-heading"
                    role="region"
                >
                    <div className="max-w-6xl mx-auto">
                        <header className="text-center mb-16">
                            <div className="inline-block px-4 py-2 bg-gradient-to-r from-blue-100 to-teal-100 text-blue-700 rounded-full text-sm font-semibold mb-4">
                                CORE VALUES
                            </div>
                            <h2 id="core-values-heading" className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
                ...
                <section
                    className="py-20 px-5 lg:px-30 bg-gradient-to-b from-blue-50/30 to-teal-50/30"
                ...
                >
                    <div className="max-w-4xl mx-auto">
                        <header className="text-center mb-16">
                            ...
                            <h2 id="journey-heading" className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
                        ...
                        <div className="relative">
                            ...
                            <div
                                className="absolute left-6 lg:left-1/2 lg:-translate-x-1/2 top-0 bottom-0 w-1 bg-gradient-to-b from-blue-300 via-teal-300 to-blue-300"
                                aria-hidden="true"
                            />
                ...
                >
                    <div className="max-w-4xl mx-auto">
                        <header className="text-center mb-16">
                            ...
                            <h2 id="philosophy-heading" className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
                                Simple Principles, Extraordinary Results
                            </h2>
                        </header>

                        <article className="bg-gradient-to-br from-blue-50 to-teal-50 rounded-3xl p-12 shadow-xl">
